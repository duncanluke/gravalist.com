...
export function SeriesPage({ onEventSelect, userEmail, onNavigateToAddRoute }: SeriesPageProps) {
  const { 
    events, 
  ...
  const getUserProgress = (eventId: string, eventName: string) => {
    ...
    // Total steps: 0-13 = 14 steps total (before: 0-9, starting: 10-13)
    const totalSteps = 14;
    
    return {
      currentStep: actualStep,
      totalSteps,
      isCompleted: completed || actualStep >= 13, // Completed when reached final step (13)
                    ...
                    return (
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {progress.isCompleted && (
                            <Badge variant="outline" className="text-[#33D17A] border-[#33D17A] bg-[#33D17A]/10">
